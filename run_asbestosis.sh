...
IMAGE_SIZE="${ASBESTOSIS_IMAGE_SIZE:-224}"
...
PRIMARY_LOSS="${ASBESTOSIS_PRIMARY_LOSS:-focal}"
FOCAL_GAMMA="${ASBESTOSIS_FOCAL_GAMMA:-2.0}"
FOCAL_ALPHA="${ASBESTOSIS_FOCAL_ALPHA:-0.25}"
